...
DPT.objects.processDirs(dirs=None, objtype=pyh.RPLSplit, channel=[*range(64, 97)]); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:864862560198:awsnotify --message "Rs3JobDone"
